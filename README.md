...
### Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=cpp,c,java,js,python,mysql,html,css,ocaml,git,github,linux,bash,docker,gdb,visualstudio,idea)](https://skillicons.dev)
